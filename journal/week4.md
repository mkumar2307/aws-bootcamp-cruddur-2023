...
gp env PROD_CONNECTION_URL="postgresql://cruddurroot:goodDatabasePassword1goodDatabasePassword1@cruddur-db-instance.cmfrnkxoejia.us-east-1.rds.amazonaws.com:5432/cruddur"
```      
...
```
PG_HOSTNAME='cruddur-db-instance.cmfrnkxoejia.us-east-1.rds.amazonaws.com'
PG_DATABASE='cruddur'
PG_USERNAME='root'
PG_PASSWORD='goodDatabasePassword1'
```    
